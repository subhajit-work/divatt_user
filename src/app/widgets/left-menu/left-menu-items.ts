...
export const MENUITEMS: Menu[] = [
  {
    title: 'Designers', path:'designer-list',type: 'sub', megaMenu: true, children: [
      {
      ...
      {
        title: 'women', type: 'link', children: [
  ...
  {
    title: 'MAN', path:'collections/collection/man' ,type: 'sub', megaMenu: true, children: [
      {
        title: 'Top Wear', type: 'link', children: [
          { path: '/collections/collection/men', title: 'Casual Shirts', type: 'link' },
          { path: '/collections/collection/men', title: 'laptop bags', type: 'link' },
          { path: '/collections/collection/men', title: 'clutches', type: 'link' },
          {
      ...
      {
        title: 'Bottom Wear', type: 'link', children: [
  ...
  {
    title: 'WOMEN', path:'collections/collection/women', type: 'sub', megaMenu: true, children: [
      {
        title: 'Top Wear', type: 'link', children: [
          { path: '/home/left-sidebar/collection/all', title: 'shopper bags', type: 'link' },
          { path: '/home/left-sidebar/collection/all', title: 'laptop bags', type: 'link' },
  ...
  {
    title: 'KIDS', path:'collections/collection/kids' ,type: 'sub', megaMenu: true, children: [
      {
        title: 'BOYS', type: 'link', children: [
          { path: '/home/left-sidebar/collection/all', title: 'shopper bags', type: 'link' },
          { path: '/home/left-sidebar/collection/all', title: 'laptop bags', type: 'link' },
          { path: '/home/left-sidebar/collection/all', title: 'clutches', type: 'link' },
          {
      ...
      {
        title: 'GIRLS', type: 'link', children: [
          { path: '/home/left-sidebar/collection/all', title: 'shopper bags', type: 'link' },
          { path: '/home/left-sidebar/collection/all', title: 'laptop bags', type: 'link' },
          { path: '/home/left-sidebar/collection/all', title: 'clutches', type: 'link' },
          {
